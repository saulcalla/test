 ...
 public class ReporteRMCBean extends ConectaBD
 {
   ...
   public Vector getPaginacion(DataSource dataSource, String strAra)
   {
     ...
     if (conecta(dataSource))
     {
       try
       {
         vInstruccion = (String)Util.getMap().get("gestion_53.inst01");
         vWhere.add("Int," + Integer.toString(getIndice()));
         vWhere.add("Int," + Integer.toString(maxIndice));
 
         vRes = consulta(dataSource, vInstruccion, vWhere, 7);
       }
       catch (Exception e) {
   ...
   public int getTotalRegistros(DataSource dataSource, String strAra)
   {
     ...
     if (conecta(dataSource))
     {
       statement = (String)Util.getMap().get("gestion_53.inst02");
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.bean.ReporteRMCBean
