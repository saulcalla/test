...
import cl.ripley.GestionTV.struts.bean.ReporteClientesEncuestaBean;
import cl.ripley.GestionTV.struts.bean.Sucursal;
import cl.ripley.GestionTV.struts.form.DetalleProductoForm;
import cl.ripley.GestionTV.struts.form.ReporteClientesEncuestaForm;

public class ReporteClientesEncuestaAction extends Action {
     ...
     throws Exception
   {
     ...
     ReporteClientesEncuestaForm conForm = (ReporteClientesEncuestaForm)form;
     ReporteClientesEncuestaBean conBean = new ReporteClientesEncuestaBean();
 
     Sucursal traSucursal = new Sucursal();
     
     if (conForm.getAccion().equals("ReporteClientesEncuesta")) {
