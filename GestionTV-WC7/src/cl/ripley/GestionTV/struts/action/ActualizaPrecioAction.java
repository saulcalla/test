 ...
 import cl.ripley.GestionTV.struts.bean.SavReporteBean;
 import cl.ripley.GestionTV.struts.bean.Sucursal;
 import cl.ripley.GestionTV.struts.form.SavReporteForm;
 ...
 public class ActualizaPrecioAction extends Action
 {
     ...
     throws Exception
   {
     ...
     SavReporteForm conForm = (SavReporteForm)form;
     SavReporteBean conBean = new SavReporteBean();
     Sucursal traSucursal = new Sucursal();
 
     if (conForm.getAccion().equals("InicioSavReporte")) {
       ...
       conForm.setCollSucursal(conBean.getCollFiltro(getDataSource(request, "Db2")));
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.ActualizaPrecioAction
