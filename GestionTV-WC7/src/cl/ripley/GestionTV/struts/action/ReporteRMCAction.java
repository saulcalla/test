 ...
 import cl.ripley.GestionTV.struts.bean.ReporteRMCBean;
 import cl.ripley.GestionTV.struts.form.ReporteRMCForm;
 ...
 public class ReporteRMCAction extends Action
 {
     ...
     throws Exception
   {
     ...
     ReporteRMCForm conForm = (ReporteRMCForm)form;
     ReporteRMCBean conBean = new ReporteRMCBean();
 
     if (conForm.getAccion().equals("InicioReporteRMC")) {
     ...
     if (conForm.getAccion().equals("buscar"))
     {
       ...
       conForm.setTotalRegistros(conBean.getTotalRegistros(getDataSource(request, "RMC"), conForm.getFec_inicio()));
       conBean.setTotalReg(conForm.getTotalRegistros());
 
       conForm.setVctDetalles(conBean.getPaginacion(getDataSource(request, "RMC"), conForm.getFec_inicio()));
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.ReporteRMCAction
