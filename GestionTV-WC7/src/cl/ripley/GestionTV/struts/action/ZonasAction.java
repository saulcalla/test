 ...
 import cl.ripley.GestionTV.struts.form.ZonasForm;
 ...
 public class ZonasAction extends Action
 {
     ...
     throws Exception
   {
     ...
     ZonasForm objForm = (ZonasForm)form;
     ...
     if (objForm.getAccion().equals("InicioZonas")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.ZonasAction
