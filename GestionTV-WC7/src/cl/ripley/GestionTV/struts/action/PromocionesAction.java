 ...
 import cl.ripley.GestionTV.struts.form.PromocionesForm;
 ...
 public class PromocionesAction extends Action
 {
     ...
     throws Exception
   {
     ...
     PromocionesForm objForm = (PromocionesForm)form;
     ...
     if (objForm.getAccion().equals("InicioPromociones")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.PromocionesAction
