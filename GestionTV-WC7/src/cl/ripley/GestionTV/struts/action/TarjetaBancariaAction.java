 ...
 import cl.ripley.GestionTV.struts.bean.TarjetaBancariaBean;
 import cl.ripley.GestionTV.struts.form.TarjetaBancariaForm;
 ...
 public class TarjetaBancariaAction extends Action
 {
     ...
     throws Exception
   {
     ...
     TarjetaBancariaForm conForm = (TarjetaBancariaForm)form;
     TarjetaBancariaBean conBean = new TarjetaBancariaBean();
     Sucursal traSucursal = new Sucursal();
 
     if (conForm.getAccion().equals("InicioTarjetaBancaria")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.TarjetaBancariaAction
