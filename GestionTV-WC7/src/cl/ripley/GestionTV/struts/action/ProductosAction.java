 ...
 import cl.ripley.GestionTV.struts.form.ProductosForm;
 ...
 public class ProductosAction extends Action
 {
     ...
     throws Exception
   {
     ...
     if (objForm.getAccion().equals("InicioProductos")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.ProductosAction
