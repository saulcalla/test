 ...
 import cl.ripley.GestionTV.struts.form.AsociacionesForm;
 ...
 public class AsociacionesAction extends Action
 {
     ...
     throws Exception
   {
     ...
     AsociacionesForm objForm = (AsociacionesForm)form;
     ...
     if (objForm.getAccion().equals("InicioAsociaciones")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.AsociacionesAction
