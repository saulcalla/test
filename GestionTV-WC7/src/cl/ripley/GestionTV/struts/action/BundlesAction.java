 ...
 import cl.ripley.GestionTV.struts.form.BundlesForm;
 ...
 public class BundlesAction extends Action
 {
     ...
     throws Exception
   {
     ...
     BundlesForm objForm = (BundlesForm)form;
     ...
     if (objForm.getAccion().equals("InicioBundles")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.BundlesAction
