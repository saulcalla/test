 ...
 import cl.ripley.GestionTV.struts.form.ClientescarForm;
 ...
 public class ClientescarAction extends Action
 {
     ...
     throws Exception
   {
     ...
     ClientescarForm objForm = (ClientescarForm)form;
     ...
     if (objForm.getAccion().equals("InicioClientescar")) {
       ...
       objForm.setVctDetTotales(OEMclientescar.CargaTotal(objBean.getTotalPaginas()));
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.ClientescarAction
