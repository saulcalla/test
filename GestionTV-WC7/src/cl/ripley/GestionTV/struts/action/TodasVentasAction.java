 ...
 import cl.ripley.GestionTV.struts.bean.TodasVentasBean;
 import cl.ripley.GestionTV.struts.form.TodasVentasForm;
 ...
 public class TodasVentasAction extends Action
 {
     ...
     throws Exception
   {
     ...
     TodasVentasForm conForm = (TodasVentasForm)form;
     TodasVentasBean conBean = new TodasVentasBean();
     Sucursal traSucursal = new Sucursal();
 
     if (conForm.getAccion().equals("InicioTodasVentas")) {
     ...
     if (conForm.getAccion().equals("excel"))
     {
       ...
       conBean.setFec_fin(conForm.getFec_fin());
       conBean.setCodSucursal(conForm.getCodSucursal());
       conBean.setVctExpHeadNota(Util.stringToVector(conForm.getVctExpHeadNota()));
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.TodasVentasAction
