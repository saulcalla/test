 ...
 import cl.ripley.GestionTV.struts.bean.ReporteWebPayIncompletaBean;
 import cl.ripley.GestionTV.struts.form.ReporteWebPayIncompletaForm;
 ...
 public class ReporteWebPayIncompletaAction extends Action
 {
     ...
     throws Exception
   {
     ...
     ReporteWebPayIncompletaForm conForm = (ReporteWebPayIncompletaForm)form;
     ReporteWebPayIncompletaBean conBean = new ReporteWebPayIncompletaBean();
 
     if (conForm.getAccion().equals("InicioReporteWebPayIncompleta")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.ReporteWebPayIncompletaAction
