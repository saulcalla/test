 ...
 import cl.ripley.GestionTV.struts.bean.TarjetaRipleyBean;
 import cl.ripley.GestionTV.struts.form.TarjetaRipleyForm;
 ...
 public class TarjetaRipleyAction extends Action
 {
     ...
     throws Exception
   {
     ...
     TarjetaRipleyForm conForm = (TarjetaRipleyForm)form;
     TarjetaRipleyBean conBean = new TarjetaRipleyBean();
     Sucursal traSucursal = new Sucursal();
 
     if (conForm.getAccion().equals("InicioTarjetaRipley")) {
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.TarjetaRipleyAction
