 ...
 import cl.ripley.GestionTV.struts.bean.TarjetaRipleyDatosBean;
 import cl.ripley.GestionTV.struts.form.TarjetaRipleyDatosForm;
 import cl.ripley.framework.mvc.action.ForwardParameters;
 import cl.ripley.framework.mvc.action.GestionTVBeanFactory;
 ...
 public class TarjetaRipleyDatosAction extends Action
 {
     ...
     throws Exception
   {
     ...
     TarjetaRipleyDatosForm conForm = (TarjetaRipleyDatosForm)form;
     TarjetaRipleyDatosBean conBean = new TarjetaRipleyDatosBean();
 
     if (conForm.getAccion().equals("InicioRipleyDatos")) {
     ...
     {
       GestionTVBeanFactory.getBeanArray().clear();
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.action.TarjetaRipleyDatosAction
