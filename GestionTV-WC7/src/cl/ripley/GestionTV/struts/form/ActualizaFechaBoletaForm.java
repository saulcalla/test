 ...
 public class ActualizaFechaBoletaForm extends ActionForm
 {
   ...
   public String getFec_nueva() {
     return this.fec_nueva;
   }
 
   public void setFec_nueva(String fec_hasta) {
     this.fec_nueva = fec_hasta;
   }
 ...
 * Qualified Name:     cl.ripley.GestionTV.struts.form.ActualizaFechaBoletaForm
