...
<% String vFormulario   = new String("tarjetaripleydatosForm");%>
<% String vSend 		= new String("buscar");%>
<% String vForm 		= new String("document.tarjetaripleydatosForm");%>
<% String titulogeneral = new String("tarjetaRipleyDatos.titGeneral");%>
<% String titulopagina  = new String("tarjetaRipleyDatos.titPagina");%>
<% String vaccion 		= new String("/tarjetaripleydatos");%>
<% String accioninicio  = new String("InicioTarjetaRipleyDatos");%>
<% String vcolumna		= new String("tarjetaRipleyDatos.form1.campo");%>
<% String btncancelar 	= new String("tarjetaRipleyDatos.form1.boton.cancelar");%>
<% String btnbuscar 	= new String("tarjetaRipleyDatos.form1.boton.buscar");%>
<% String parametro 	= new String("tarjetaRipleyDatos.titfecha");%>
...
<script language="javascript">
	...
	{
		var obj = document.tarjetaripleydatosForm;
  		...
  		<tr> 
			...
			<td class="StyleTextoTabla">
   			...
   			<td class="StyleTextoTabla">
   		        ...
   		        <input type=button name="BtnFecha" value="C" onclick="goWindowPopupCalendario('tarjetaripleyForm','fec_inicio');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
    		</td>
			<td align="right"> 
