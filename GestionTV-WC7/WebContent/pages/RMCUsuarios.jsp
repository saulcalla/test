...
<% String vFormulario 	= new String("reporteRMCForm"); %>
<% String vSend 		= new String("buscar"); %>
<% String vForm 		= new String("document.reporteRMCForm"); %>
<% String titulogeneral = new String("rmcUsuarios.titGeneral"); %>
<% String titulopagina 	= new String("rmcUsuarios.titPagina"); %>
<% String vaccion 		= new String("/ReporteRMC"); %>
<% String accioninicio 	= new String("InicioReporteRMC"); %>
<% String vcolumna 		= new String("rmcUsuarios.campo"); %>
<% String btncancelar 	= new String("rmcUsuarios.boton.cancelar"); %>
<% String btnbuscar 	= new String("rmcUsuarios.boton.buscar"); %>
<% int 	  numcol 		= 7; %>
...
{
	var obj = document.reporteRMCForm;
...
<!-- END -- RC & PP -- 26/10/2004 -->	
	<table border="0"class="StyleTextoTablaRegalos" align="center" > 
		<tr>
<%
