...
<%
	String vFormulario = new String("reporteClientesEncuestaForm");
%>
<%
	String vSend = new String("buscar");
%>
<%
	String vForm = new String("document.reporteClientesEncuestaForm");
%>
<%
	String titulogeneral = new String(
			"reporteUsuariosEncuesta.titGeneral");
%>
<%
	String titulopagina = new String(
			"reporteUsuariosEncuesta.titPagina");
%>
<%
	String vaccion = new String("/ReporteClientesEncuesta");
%>
<%
	String accioninicio = new String("ReporteClientesEncuesta");
%>
<%
	String btncancelar = new String(
			"reporteUsuariosEncuesta.form1.boton.cancelar");
%>
<%
	String vcolumna = new String("reporteUsuariosEncuesta.form1.campo");
%>
<%
	String btnbuscar = new String(
			"reporteUsuariosEncuesta.form1.boton.buscar");
%>
<%
	String parametroIni = new String(
			"reporteUsuariosEncuesta.titfechaIni");
%>
<%
	String parametroFin = new String(
			"reporteUsuariosEncuesta.titfechaFin");
%>
<%
...
{
	var obj = document.reporteClientesEncuestaForm;
	...
	<div align="center">
		...
		<html:form action="<%=vaccion%>">
			...
			<input type="hidden" name="contador"
				value='<bean:write name="<%=vFormulario%>" property="contador"/>'>
			<input type="hidden" name="indice"
				value='<bean:write name="<%=vFormulario%>" property="indice" />'>
			<input type="hidden" name="registrosPorBloque"
				value='<bean:write name="<%=vFormulario%>" property="registrosPorBloque"/>'>
			<input type="hidden" name="nroBloque"
				value='<bean:write name="<%=vFormulario%>" property="nroBloque"/>'>
			<input type="hidden" name="hayProximoBloque"
				value='<bean:write name="<%=vFormulario%>" property="hayProximoBloque"/>'>
			...
			<table width="30%" align="center" class="StyleTabla_TodasVentas">
				...
				<tr>
					<td>&nbsp;</td>
					<td class="StyleTextoTabla"><bean:message
							key="<%=parametroIni%>" /> <html:text name="<%=vFormulario%>"
							property="<%=paramfiltroIni%>" size="10" maxlength="10"
							onkeypress="return valida_caracteres(event,lista);"
							onblur="ValidaFecha(this)" /> <input type=button
						name="BtnFechaIni" value="C"
						onclick="goWindowPopupCalendario('reporteClientesEncuestaForm','fec_inicio');"
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <bean:message
							key="<%=parametroFin%>" /> <html:text name="<%=vFormulario%>"
							property="<%=paramfiltroFin%>" size="10" maxlength="10"
							onkeypress="return valida_caracteres(event,lista);"
							onblur="ValidaFecha(this)" /> <input type=button
						name="BtnFechaFin" value="C"
						onclick="goWindowPopupCalendario('reporteClientesEncuestaForm','fec_fin');"
						STYLE="border: 1px solid white; height: 20px;"
						onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'"
						onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
					...
					<td align="right"><input type="button" name="btn_buscar"
						value="Buscar" onclick="do_buscar();"
						STYLE="border: 1px solid white; width: 80px"
						onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'"
						onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
					</td>
					<td align="left"><input type="button" name="btnLimpiar"
						value="Limpiar" onclick="btnLimpiar_onclick();"
						STYLE="border: 1px solid white; width: 80px"
						onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'"
						onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
					</td>
			...
			<logic:equal name="<%=vFormulario%>" property="hayDatos" value="si">
				...
				<!-- END -- RC & PP -- 26/10/2004 -->
				<table border="0" class="StyleTabla_DetalleProducto" align="center">
					<tr>
						<%
							for (int i = 1; i <= numcol; i++) {
										...
										if (i == 4) {
						%>
						<td align="center" width="110px"><font
							class="StyleTextoTabla"><bean:message key="<%=temp%>" />
						</font>
						</td>
						<%
							} else if (i == 5) {
						...
						%>
						<td align="center" width="80px"><font class="StyleTextoTabla"><bean:message
									key="<%=temp%>" />
						</font>
						</td>
						<%
					...
					<logic:iterate id="campos" name="<%=vFormulario%>" property="vctDetalles">
						<tr> 
							<logic:iterate id="dato" name="campos" indexId="index">
									<td class="VectResultDat1"><font class="VectResultDat1"><bean:write name="dato"/></font></td>				 
							</logic:iterate>
						</tr>
					</logic:iterate>
				</table>
			...
			<table border="0" class="StyleTabla_TodasVentas" align="center">
				<tr>
					<td align="center"><input type="button" name="btnCerrar"
						...
						onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'"
						onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
						<logic:equal name="<%=vFormulario%>" property="hayDatos"
							value="si">
							<input type="button" name="btnExportar" value="Exportar"
								...
								onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'"
								onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
						</logic:equal> <logic:notEqual name="<%=vFormulario%>" property="hayDatos"
							value="si">
