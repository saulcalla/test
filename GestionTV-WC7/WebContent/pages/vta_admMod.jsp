...
<head>
	...
	<meta name="pagina"        content="pages/vta_admMod.jsp">
	<meta name="modificado"    content="vta_admMod.14Julio2006">
	...
	function do_grabar() {
		...
		var mensaje = "";
		mensaje = valida_campo_requerido(obj.telefono1.value,"<bean:message key="banco.ciudad"/>","<bean:message key="errors.requerido"/>")
		mensajeglosa = mensajeglosa + mensaje;
		if ( (mensaje!="") && (foco==false ) ) {
		    foco=true;
			obj.telefono1.focus();
		...
		obj.accion.value = "grabar_modificar_adm";
		obj.submit();
	}
...
<html:form action="/banco">
   ...
   <html:hidden property="valorCP" value=""/>


	<font class="StyleHead_left"><bean:message key="banco.adm.modFuncion.form1"/></font><br><br>
	...
	<table class="StyleTabla_75">
		<tr>
			...
			<td class="StyleTextoTabla">
				<html:text property="ejecutivo" size="38" maxlength="10" disabled="true" styleClass="StyleText"/>
			</td>
		</tr>
		<tr>
			<td class="StyleTextoTabla">
	...
	<table class="StyleTabla_75">
		<tr>
			...
			<td class="StyleTextoTabla">
				<html:text property="nombreProducto" size="30" maxlength="50" onkeypress="return valida_caracteres(event,LGLOSA);"/>
			</td>
		</tr>
		<tr>
			<td class="StyleTextoTabla">
				<bean:message key="banco.cod.producto.cambio"/>
			</td> 
			<td class="StyleTextoTabla">
				<html:text property="codigoCP" size="15" maxlength="25" onkeypress="return valida_caracteres(event,LNUM);"/>
			</td>
			<td class="StyleTextoTabla">
				<bean:message key="banco.nom.producto.cambio"/>
			</td> 
			<td class="StyleTextoTabla">
				<html:text property="nombreCP" size="10" maxlength="50" onkeypress="return valida_caracteres(event,LGLOSA);"/>
			</td>
		</tr>
		<tr>
			<td class="StyleTextoTabla">
		...
		<tr>
			<td class="StyleTextoTabla">
				<bean:message key="banco.oc"/>
			</td> 
			<td class="StyleTextoTabla">
				<html:text property="ordenCompra" size="15" maxlength="15" onkeypress="return valida_caracteres(event,LNUM);"/>
			</td>
			<td class="StyleTextoTabla">
				<bean:message key="banco.estado"/>
			</td> 
			<td class="StyleTextoTabla">
				<html:select property="selectEstado">
