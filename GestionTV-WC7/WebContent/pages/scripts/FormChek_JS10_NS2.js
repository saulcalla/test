...
// Compara fechas dd/mm/yyyy
function ComparaFecha(fechaini,fechafin) 
{
var auxfechaini = "";
var auxfechafin = "";

 auxfechaini = fechaini.value.substr(6,4) + 
 			   fechaini.value.substr(3,2) +
 			   fechaini.value.substr(0,2); 
 auxfechafin = fechafin.value.substr(6,4) + 
 			   fechafin.value.substr(3,2) + 
 			   fechafin.value.substr(0,2); 

  return (auxfechaini <= auxfechafin);
...
function valida_campo_requerido(objeto,campo,msg) {
	var mensaje = "";
		if (isWhitespace (objeto)) {
			mensaje = campo + " " + msg + "\n";
		}
		return (mensaje);
}
