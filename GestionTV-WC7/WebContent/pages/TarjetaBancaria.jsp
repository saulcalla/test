...
<% String vFormulario 	= new String("tarjetabancariaForm"); %>
<% String vSend 		= new String("buscar"); %>
<% String vForm 		= new String("document.tarjetabancariaForm"); %>
<% String titulogeneral = new String("tarjetaBancaria.titGeneral"); %>
<% String titulopagina 	= new String("tarjetaBancaria.titPagina"); %>
<% String vaccion 		= new String("/tarjetabancaria"); %>
<% String accioninicio 	= new String("InicioTarjetaBancaria"); %>
<% String vcolumna 		= new String("tarjetaBancaria.form1.campo"); %>
<% String btncancelar 	= new String("tarjetaBancaria.form1.boton.cancelar"); %>
<% String btnbuscar 	= new String("tarjetaBancaria.form1.boton.buscar"); %>
<% String parametro 	= new String("tarjetaBancaria.titfecha"); %>
...
{
	var obj = document.tarjetabancariaForm;
  		...
  		<tr>
			...
			<td class="StyleTextoTabla">
   			...
   			<td class="StyleTextoTabla">
		        ...
		        <input type=button name="BtnFecha" value="C" onclick="goWindowPopupCalendario('tarjetabancariaForm','fec_inicio');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
    		</td>
			<td class="StyleTextoTabla">
