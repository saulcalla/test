...
<% String vFormulario   = new String("tarjetaripleyForm");%>
<% String vSend 		= new String("buscar");%>
<% String vForm 		= new String("document.tarjetaripleyForm");%>
<% String titulogeneral = new String("tarjetaRipley.titGeneral");%>
<% String titulopagina  = new String("tarjetaRipley.titPagina");%>
<% String vaccion 		= new String("/tarjetaripley");%>
<% String accioninicio  = new String("InicioTarjetaRipley");%>
<% String vcolumna 		= new String("tarjetaRipley.form1.campo");%>
<% String btncancelar 	= new String("tarjetaRipley.form1.boton.cancelar");%>
<% String btnbuscar 	= new String("tarjetaRipley.form1.boton.buscar");%>
<% String parametro 	= new String("tarjetaRipley.titfecha");%>
...
{
	var obj = document.tarjetaripleyForm;
