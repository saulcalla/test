...
<% String vFormulario 	= new String("savReporteForm"); %>
<% String vSend 		= new String("buscar"); %>
<% String vForm 		= new String("document.savReporteForm"); %>
<% String titulogeneral = new String("savReporteForm.titGeneral"); %>
<% String titulopagina 	= new String("savReporteForm.titPagina"); %>
<% String vaccion 		= new String("/savReporte"); %>
<% String accioninicio 	= new String("InicioSavReporte"); %>
<% String vcolumna 		= new String("savReporteForm.form1.campo"); %>
<% String btncancelar 	= new String("savReporteForm.form1.boton.cancelar"); %>
<% String btnbuscar 	= new String("savReporteForm.form1.boton.buscar"); %>
<% String parametro 	= new String("savReporteForm.titfecha"); %>
...
{
	var obj = document.savReporteForm;
  		...
  		<tr>
			...
			<td class="StyleTextoTabla">
   			...
   			<td class="StyleTextoTabla">
		        ...
		        <input type=button name="BtnFecha" value="C" onclick="goWindowPopupCalendario('savReporteForm','fec_inicio');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
    		</td>
			<td class="StyleTextoTabla">
