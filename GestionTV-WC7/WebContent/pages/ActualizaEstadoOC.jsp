...
<% String vFormulario 	= new String("actualizaEstadoOCForm"); %>
<% String vSend 		= new String("buscar"); %>
<% String vForm 		= new String("document.actualizaEstadoOCForm"); %>
<% String titulogeneral = new String("reporteRegalo.titGeneral"); %>
<% String titulopagina 	= new String("reporteRegalo.titPagina"); %>
<% String vaccion 		= new String("/actualizaEstadoOC"); %>
<% String accioninicio 	= new String("InicioActualizaEstadoOC"); %>
<% String vcolumna 		= new String("actualizaEstadoOC.form1.campo"); %>
<% String btncancelar 	= new String("actualizaEstadoOC.form1.boton.cancelar"); %>
<% String btnbuscar 	= new String("actualizaEstadoOC.form1.boton.buscar"); %>
<% String parametroCodRegalo 	= new String("actualizaEstadoOC.titCodRegalo"); %>
<% int 	  numcol 		= 18; %>
...
{
	var obj = document.actualizaEstadoOCForm;
