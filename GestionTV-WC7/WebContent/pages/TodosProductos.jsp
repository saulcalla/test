...
function do_cancelar() {
		var obj = document.todosproductosForm;
...
{
	obj = document.todosproductosForm;	
	var temp="<bean:write name="todosproductosForm" property="hayDatos" />"
...
<html>
<head>
	<title><bean:message key="todosProductos.titGeneral"/></title>
...
<div align="center">
<font class="StyleHead_left"><bean:message key="todosProductos.titPagina"/></font>
<!-- Para la accion -->
<html:form action="/todosproductos">
  <html:hidden property="accion" value=""/>
  <html:hidden property="vctExpHead" value=""/>
  	<html:hidden property="exportFile" /> 
  	<input type="hidden" name="mensaje"   value='<bean:write name="todosproductosForm" property="mensaje" />'>
  <table border="0" class="StyleTabla_75" align="center">
	<tr>
	    <!-- Nombre de las columnas a desplegar -->			
   		  <td><font class="StyleTextoTabla"><bean:message key="todosProductos.titulo.columna1"/></font></td>
		  <td><font class="StyleTextoTabla"><bean:message key="todosProductos.titulo.columna2"/></font></td>
	</tr>
		<logic:iterate id="campos" name="todosproductosForm" property="vctDetalles">
			<tr>
  ...
  <tr>
	 <td align="center">
   	...
   	<logic:equal name="todosproductosForm" property="hayDatos" value="si">
	...
	<logic:notEqual name="todosproductosForm" property="hayDatos" value="si">
