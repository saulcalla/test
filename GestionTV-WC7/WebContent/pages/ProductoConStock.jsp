...
function do_cancelar() {
		var obj = document.productoconstockForm;
...
{
	obj = document.productoconstockForm;	
	var temp="<bean:write name="productoconstockForm" property="hayDatos" />"
...
<html>
<head>
	<title><bean:message key="productoConStock.titGeneral"/></title>
...
<div align="center">
<font class="StyleHead_left"><bean:message key="productoConStock.titPagina"/></font>
<!-- Para la accion -->
<html:form action="/productoconstock">
	<html:hidden property="vctExpHead" value=""/>
	<input type="hidden" name="mensaje"   value='<bean:write name="productoconstockForm" property="mensaje" />'>
  	<html:hidden property="accion" value=""/>
	<html:hidden property="exportFile" /> 
  <table border="0" class="StyleTabla_75" align="center">
	<tr>
	    <!-- Nombre de las columnas a desplegar -->			
   		  <td><font class="StyleTextoTabla"><bean:message key="productoConStock.titulo.columna1"/></font></td>
		  <td><font class="StyleTextoTabla"><bean:message key="productoConStock.titulo.columna2"/></font></td>
	</tr>
		<logic:iterate id="campos" name="productoconstockForm" property="vctDetalles">
			<tr>
  ...
  <tr>
	...
	<logic:equal name="productoconstockForm" property="hayDatos" value="si">
	...
	<logic:notEqual name="productoconstockForm" property="hayDatos" value="si">
