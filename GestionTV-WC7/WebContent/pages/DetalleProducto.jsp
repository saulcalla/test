...
<% String vFormulario 	= new String("detalleproductoForm"); %>
<% String vSend 		= new String("buscar"); %>
<% String vForm 		= new String("document.detalleproductoForm"); %>
<% String titulogeneral = new String("detalleProducto.titGeneral"); %>
<% String titulopagina 	= new String("detalleProducto.titPagina"); %>
<% String vaccion 		= new String("/detalleproducto"); %>
<% String accioninicio 	= new String("InicioDetalleProducto"); %>
<% String vcolumna 		= new String("detalleProducto.form1.campo"); %>
<% String btncancelar 	= new String("detalleProducto.form1.boton.cancelar"); %>
<% String btnbuscar 	= new String("detalleProducto.form1.boton.buscar"); %>
<% String parametroIni 	= new String("detalleProducto.titfechaIni"); %>
<% String parametroFin 	= new String("detalleProducto.titfechaFin"); %>
...
{
	var obj = document.detalleproductoForm;
    	...
    	<tr>
  		...
  		<tr> 
			...
			<td class="StyleTextoTabla">
			    ...
			    <input type=button name="BtnFechaIni" value="C" onclick="goWindowPopupCalendario('detalleproductoForm','fec_inicio');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    ...
			    <input type=button name="BtnFechaFin" value="C" onclick="goWindowPopupCalendario('detalleproductoForm','fec_fin');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
