...
<% String vFormulario = new String("asociacionesForm"); %>
<% String vForm = new String("document.asociacionesForm"); %>
<% String vcolumna = new String("asociaciones.col"); %>
<% int numcol = 6; %>
<head>
...
<script language="javascript">
  ...
  function do_cancelar() {
	var obj = document.asociacionesForm;
...
<div align="center">
<font class="StyleHead_left"><bean:message key="asociaciones.titPagina"/></font>
<br>
<html:form action="/asociaciones">
...
<br>
<logic:equal name="asociacionesForm" property="hayDatos" value="si">  
  <logic:present name="asociacionesForm">
    <table border="0" class="StyleTabla_75" align="center">
		<tr>
			<td align="center"><font class="StyleTextoTabla"><bean:message key="asociaciones.form1.campo0"/></font></td>
		    <td align="center"><font class="StyleTextoTabla"><bean:message key="asociaciones.form1.campo1"/></font></td>
		    <td align="center"><font class="StyleTextoTabla"><bean:message key="asociaciones.form1.campo2"/></font></td>
		    <td align="center"><font class="StyleTextoTabla"><bean:message key="asociaciones.form1.campo3"/></font></td>
		    <td align="center"><font class="StyleTextoTabla"><bean:message key="asociaciones.form1.campo4"/></font></td>
		    <td align="center"><font class="StyleTextoTabla"><bean:message key="asociaciones.form1.campo5"/></font></td>			    			    			    			    
	 	</tr>
	 <logic:iterate id="campos" name="asociacionesForm" property="vctDetalles">
       <tr>
...
<br>
	...
	<td align="left">
		...
		<logic:equal name="asociacionesForm" property="numeroPagina" value="1">
		...
		<logic:notEqual name="asociacionesForm" property="numeroPagina" value="1">
	...
	<td>
		...
		<table width="100%" border="0" align="center">
			 ...
			 <td class="StyleText">  
			 <div align="center">
			 <logic:iterate id="campos" name="asociacionesForm" property="listaPagina">
	...
	<td align="right">
		...
		<logic:equal name="asociacionesForm" property="hayProximoBloque" value="si">
		...
		<logic:notEqual name="asociacionesForm" property="hayProximoBloque" value="si">
