...
<% String vFormulario = new String("productosForm"); %>
<% String vForm = new String("document.productosForm"); %>
<% String vcolumna = new String("productos.col"); %>
<% int numcol = 22; %>
<html>
<head>
	<title><bean:message key="productos.titGeneral"/></title>
	<meta name="pagina" content="Productos.jsp">
...
<script language="javascript">
  ...
  function do_cancelar() {
	var obj = document.productosForm;
...
<div align="center">
<font class="StyleHead_left"><bean:message key="productos.titPagina"/></font>
<br>
...
<input type="hidden" name="mensaje"   value='<bean:write name="<%=vFormulario%>" property="mensaje" />'>
   ...
   <br>
<logic:equal name="productosForm" property="hayDatos" value="si">  
	<logic:present name="productosForm">
    <table border="0" class="StyleTabla_75" align="center">
    <tr>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo1"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo2"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo3"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo4"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo5"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo6"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo7"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo8"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo9"/></font></td>			    
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo10"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo11"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo12"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo13"/></font></td>			    
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo14"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo15"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo16"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo17"/></font></td>			    
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo18"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo19"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo20"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo21"/></font></td>
		   <td align="center"><font class="StyleTextoTabla"><bean:message key="productos.form1.campo22"/></font></td>			    
     </tr>
	 <logic:iterate id="campos" name="productosForm" property="vctDetalles">
		<tr>
	...
	<td align="left">
		...
		<logic:equal name="productosForm" property="numeroPagina" value="1">
		...
		<logic:notEqual name="productosForm" property="numeroPagina" value="1">
	...
	<td>
		...
		<table width="100%" border="0" align="center">
			 ...
			 <td class="StyleText">  
			 <div align="center">
			 <logic:iterate id="campos" name="productosForm" property="listaPagina">
			    &nbsp;<input type="button" name="btnPage_<%=idxBtn++%>" value="<bean:write name='campos'/>" onclick="a_onclick(<bean:write name='campos'/>);" STYLE="border:1px solid white; width:25px" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
			 </logic:iterate>
			 </div>
			 </td>
			 </tr>
	...
	<td align="right">
		...
		<logic:equal name="productosForm" property="hayProximoBloque" value="si">
		...
		<logic:notEqual name="productosForm" property="hayProximoBloque" value="si">
