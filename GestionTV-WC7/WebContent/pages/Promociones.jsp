...
<% String vFormulario = new String("promocionesForm"); %>
<% String vForm = new String("document.promocionesForm"); %>
<% String vcolumna = new String("promociones.col"); %>
<% int numcol = 14; %>
<head>
	<title><bean:message key="promociones.titGeneral"/></title>
...
<script language="javascript">
  ...
  function do_cancelar() {
	var obj = document.promocionesForm;
...
<div align="center">
<font class="StyleHead_left"><bean:message key="promociones.titPagina"/></font>
<br>
<html:form action="/promociones">
...
<br>
<logic:equal name="promocionesForm" property="hayDatos" value="si">  

<logic:present name="promocionesForm">
	<table border="0" class="StyleTabla_75" align="center">
	<tr>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo1"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo2"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo3"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo4"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo5"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo6"/></font></td>			    			    			    			    
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo7"/></font></td>			    			    			    			    			    
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo8"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo9"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo10"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo11"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo12"/></font></td>			    			    			    			    
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo13"/></font></td>
	    <td align="center"><font class="StyleTextoTabla"><bean:message key="promociones.form1.campo14"/></font></td>
	</tr>
    <logic:iterate id="campos" name="promocionesForm" property="vctDetalles">
	<tr>
...
<br>
	...
	<td align="left">
		...
		<logic:equal name="promocionesForm" property="numeroPagina" value="1">
		...
		<logic:notEqual name="promocionesForm" property="numeroPagina" value="1">
	...
	<td>
		...
		<table width="100%" border="0" align="center">
			 ...
			 <td class="StyleText">  
			 <div align="center">
			 <logic:iterate id="campos" name="promocionesForm" property="listaPagina">
	...
	<td align="right">
		...
		<logic:equal name="promocionesForm" property="hayProximoBloque" value="si">
		...
		<logic:notEqual name="promocionesForm" property="hayProximoBloque" value="si">
