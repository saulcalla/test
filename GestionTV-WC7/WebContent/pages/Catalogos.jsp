...
<% String vFormulario = new String("catalogosForm"); %>
<% String vForm = new String("document.catalogosForm"); %>
<% String vcolumna = new String("catalogos.col"); %>
<% int numcol = 10; %>

<head>
	<title><bean:message key="catalogos.titGeneral"/></title>
	<meta name="pagina" content="Catalogos.jsp">
...
<script language="javascript">
  ...
  function do_cancelar() {
	var obj = document.catalogosForm;
...
<div align="center">
<font class="StyleHead_left"><bean:message key="catalogos.titPagina"/></font>
<br>
<html:form action="/catalogos">
...
<br>
<logic:equal name="catalogosForm" property="hayDatos" value="si">  
 <logic:present name="catalogosForm">
   <table border="0" class="StyleTabla_75" align="center">
    <tr>
	   <tr>
	     <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo0"/></font></td>
	     <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo1"/></font></td>
	     <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo2"/></font></td>
	     <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo3"/></font></td>
	     <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo4"/></font></td>
	     <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo5"/></font></td>			    			    			    			    
		 <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo6"/></font></td>			    			    			    			    			    
		 <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo7"/></font></td>			    			    			    			    
		 <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo8"/></font></td>			    			    			    			    
		 <td align="center"><font class="StyleTextoTabla"><bean:message key="catalogos.form1.campo9"/></font></td>			    			    			    			    			    			    
	  </tr>
	 </tr>
     <td>
	 </td>
	 <logic:iterate id="campos" name="catalogosForm" property="vctDetalles">
	    <tr>
...
<br>
	...
	<td align="left">
		...
		<logic:equal name="catalogosForm" property="numeroPagina" value="1">
		...
		<logic:notEqual name="catalogosForm" property="numeroPagina" value="1">
	...
	<td>
		...
		<table width="100%" border="0" align="center">
			 ...
			 <td class="StyleText">  
			 <div align="center">
			 <logic:iterate id="campos" name="catalogosForm" property="listaPagina">
	...
	<td align="right">
		...
		<logic:equal name="catalogosForm" property="hayProximoBloque" value="si">
		...
		<logic:notEqual name="catalogosForm" property="hayProximoBloque" value="si">
