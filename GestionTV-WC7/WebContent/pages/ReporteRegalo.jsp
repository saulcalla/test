...
<% String vFormulario 	= new String("reporteregaloForm"); %>
<% String vSend 		= new String("buscar"); %>
<% String vForm 		= new String("document.reporteregaloForm"); %>
<% String titulogeneral = new String("reporteRegalo.titGeneral"); %>
<% String titulopagina 	= new String("reporteRegalo.titPagina"); %>
<% String vaccion 		= new String("/reporteregalo"); %>
<% String accioninicio 	= new String("InicioReporteRegalo"); %>
<% String vcolumna 		= new String("reporteRegalo.form1.campo"); %>
<% String btncancelar 	= new String("reporteRegalo.form1.boton.cancelar"); %>
<% String btnbuscar 	= new String("reporteRegalo.form1.boton.buscar"); %>
<% String parametroFechaInicio 	= new String("reporteRegalo.titfechainicio"); %>
<% String parametroFechaHasta = new String("reporteRegalo.titfechaHasta"); %>
<% String parametroCodRegalo 	= new String("reporteRegalo.titCodRegalo"); %>
...
{
	var obj = document.reporteregaloForm;
	...
	function validaCampoNulo() {
		...
		//if(obj.<%=paramFechaInicio%>.value != "" && obj.<%=paramFechaHasta%>.value != "" && obj.codRegalo.value != "" ) {
		//	alert("La busqueda debe ser por 'codigo de regalos' o por 'fechas'");
		//	obj.<%=paramFechaInicio%>.value = "";
		//	obj.<%=paramFechaHasta%>.value = ""
		//	obj.codRegalo.value = "";
		//	obj.codRegalo.focus();			
		//	return(true);
		//}
  	...
  	<table width="30%" align="center" class="StyleTabla_75">
    	...
    	<td>&nbsp;</td>
			<td class="StyleTextoTabla">
				<bean:message key="<%=parametroCodRegalo%>"/>
			</td>
	    	<td class="StyleTextoTabla">
			   	<html:text name="<%=vFormulario%>" property="codRegalo" onkeypress="return acceptNum(event)" size="10" maxlength="10" />  			
			</td>
    	</tr>    	
  		<tr> 
			<td>&nbsp;</td>
			<td class="StyleTextoTabla">
   			...
   			<td class="StyleTextoTabla">
   		        ...
   		        <input type=button name="BtnFecha" value="C" onclick="goWindowPopupCalendario('reporteregaloForm','fec_inicio');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
    		</td>			
    	...
    	<tr> 
			...
			<td class="StyleTextoTabla">
   			...
   			<td class="StyleTextoTabla">
   		        ...
   		        <input type=button name="BtnFechaHasta" value="C" onclick="goWindowPopupCalendario('reporteregaloForm','fec_hasta');" STYLE="border:1px solid white; height:20px;" onMouseover="this.style.cursor = 'hand'; style.background='#F0F0F0'; style.border='1px solid gray'" onMouseout="style.background='#CCCCCC'; style.border='1px solid white'">
    		</td>
...
<!-- END -- RC & PP -- 26/10/2004 -->	
	<table border="0"class="StyleTabla_regalos" align="center" > 
		<tr>
<%
